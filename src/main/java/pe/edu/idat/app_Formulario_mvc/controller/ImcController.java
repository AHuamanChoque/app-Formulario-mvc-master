...
import pe.edu.idat.app_Formulario_mvc.model.ImcModel;
import pe.edu.idat.app_Formulario_mvc.model.PacienteModel;
...
public class ImcController {
    ...
    public String imc(Model model){
        ...
        model.addAttribute("objimc", new ImcModel());
        return "frmimc";
    }

    @PostMapping("/imc")
    public String calcularimc(ImcModel imcModel, Model model){
        ...
        if (valorImc <= 16){
            ...
            diagnostico = "con peso leve";
        }
        else if (valorImc <= 29){
            diagnostico = "con peso media";
        }
        else {
            diagnostico = "con obesida mórbida";
        }
        ...
        model.addAttribute("objimc", new ImcModel());
        pacientes.add(PacienteModel.builder()
